        ...
        <main className="mb-[5rem]">
            <div className="relative pt-5 mb-5 h-[calc(100vw-128px)] w-full">
                <div className="ring-primary mx-auto ring-offset-base-100 w-[calc(100vw-128px)] ring rounded-full ring-offset-2">
                    <div data-loaded='false' className='z-10 w-[calc(100vw-128px)] h-full data-[loaded=false]:skeleton data-[loaded=false]:shrink-0 data-[loaded=false]:rounded-full absolute top-5 left-1/2 transform -translate-x-1/2' data-profile={user.username}></div>
                    <Image
                        data-loaded='false'
                        onLoad={event => {
            ...
            <div className="badge badge-primary grid grid-cols-3 place-items-center mb-5 w-[90vw] mx-auto">
                <div className="">{user.point}P</div>
                <div className="whitespace-nowrap">{user.tag}</div>
                {user.star ? (
                    <div className="text-warning flex">
                        {[...Array(user.star).keys()].map((key: number) =>
                            <svg key={key} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4">
